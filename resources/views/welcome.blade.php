   ...
   <script src="https://kit.fontawesome.com/a48a021ab7.js" crossorigin="anonymous"></script>
    ...
    <!-- frequently ask quention section -->
     <div class="section mx-5">
      <h1 class="text-center my-4 fw-bold">frequently Ask <span class="text-success">Quentions</span></h1>
      <div class="row ">
        <div class="col-md-6 ">
       ...
       <!-- happy clients -->
       <section class="section-fluid mx-5 p-4 mt-4">
        <h1 class="text-center mb-4">Happy clients <span class="text-warning">Says</span></h1>
            ...
            <div class="col">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-success">michel jeckshon</h5>
            ...
            <div class="col">
                <div class="card text-center shadow">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-success">Dao Hong Linh</h5>
                        <p>Hanoi, Vietnam</p>
                    </div>
                </div>
            </div>
            <div class="col text-center">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-success">Melodi Alexa</h5>
